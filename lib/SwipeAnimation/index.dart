...
class CardDemoState extends State<CardDemo> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return (new Scaffold(
        appBar: new AppBar(
          elevation: 0.0,
          backgroundColor: new Color.fromRGBO(99,99,99,99),
          centerTitle: true,
        ...
        body: new Container(
          color: new  Color.fromRGBO(115, 115, 115, 115),
          alignment: Alignment.center,
          child: dataLength > 0
              ? new Stack(
              ...
              : new Text("Não há mais profissionais por perto",textAlign: TextAlign.center,
