  ...
  Widget build(BuildContext context) {
    ...
    return new Theme(
      data: new ThemeData(
        ...
        primaryColor: const Color.fromRGBO(59, 122, 87, 0),
        platform: Theme.of(context).platform,
      ),
      child: new Container(
        width: width.value,
        height: heigth.value,
        color: const  Color.fromRGBO(59, 122, 87, 0),
        child: new Hero(
          tag: "img",
          child: new Card(
                            ...
                            child: new Padding(
                              ...
                              child: new Column(
                                ...
                                children: <Widget>[
                                  ...
                                  new Text(
                                      "Programação em Python, Java/Java EE, C, C#, C++, Lazarus/Delphi, Banco de dados (SQL), criação de aplicativos android em Kotlin e Flutter, desenvolvimento em C para Arduíno."),
                                  new Container(
